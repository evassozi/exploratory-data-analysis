...
diamonds %>% ggplot(aes(x = carat, y = price)) + 
  geom_point() + 
  geom_smooth(method = "glm") #can also use method = "lm"
...
##first using pivot_wider to spread months:
co2a <- co2 %>% pivot_wider(names_from = Month, values_from = co2)

##then use co2a to produce required plot:
co2a %>% ggplot()+
  geom_line(aes(x = Year, y = January), color = "red")+
  geom_line(aes(x = Year, y = February), color = "black")+
  geom_line(aes(x = Year, y = March), color = "blue")+
  geom_line(aes(x = Year, y = April), color = "green")+
  geom_line(aes(x = Year, y = May), color = "darkgreen")+
  geom_line(aes(x = Year, y = June), color = "orange")+
  geom_line(aes(x = Year, y = July), color = "magenta")+
  geom_line(aes(x = Year, y = August), color = "yellow")+
  geom_line(aes(x = Year, y = September), color = "brown")+
  geom_line(aes(x = Year, y = October), color = "darkblue")+
  geom_line(aes(x = Year, y = November), color = "pink")+
  geom_line(aes(x = Year, y = December), color = "red")+
  xlab("Year")+
  ylab("CO2")
...
co2a %>% ggplot()+
  geom_line(aes(x = Year, y = January), linetype = 1)+
  geom_line(aes(x = Year, y = February), linetype = 2)+
  geom_line(aes(x = Year, y = March), linetype = 3)+
  geom_line(aes(x = Year, y = April), linetype = 4)+
  geom_line(aes(x = Year, y = May), linetype = 5)+
  geom_line(aes(x = Year, y = June), linetype = 6)+
  geom_line(aes(x = Year, y = July), linetype = 1, size = 2)+
  geom_line(aes(x = Year, y = August), linetype = 2, size = 2)+
  geom_line(aes(x = Year, y = September), linetype = 3, size = 2)+
  geom_line(aes(x = Year, y = October), linetype = 4, size = 2)+
  geom_line(aes(x = Year, y = November), linetype = 5, size = 2)+
  geom_line(aes(x = Year, y = December), linetype = 6, size = 2)+
  xlab("Year")+
  ylab("CO2")
...
##first using pivot_wider to spread years:
co2b <- co2 %>% pivot_wider(names_from = Year, values_from = co2)

##then use co2b to produce required plot:
co2 %>% ggplot(aes(x = Month, y = co2)) + 
  geom_line()
...
diamonds %>%
  ggplot(aes(x = price)) +
  geom_density(aes(fill = carat), alpha = 0.2) +
  facet_wrap(~cut, scales = "free")

#Try facetting by carat and grouping by cut.
diamonds %>%
  ggplot(aes(x = price)) +
  geom_density(aes(fill = cut), alpha = 0.2 ) +
  facet_wrap(~carat, scales = "free")

# Which do you prefer?
#Prefer facetting by cut, since its a more discrete variable
...
diamonds %>%
  ggplot(aes(x = cut_interval(price, n = 5))) + 
  geom_bar() + labs(x = "Price Range", y = "Number of Diamonds", title = "Number of Diamonds in Price Ranges")
